...
class ExtractedMemoryCandidate:
    ...
    # Real triple components (§9 fix): `subject`/`object` are the normalized
    # entity/value the extractor identified, independent of whether entity
    # resolution later links either one to a graph Entity. `text` stays the
    # original extracted sentence regardless -- these are additive, not a
    # replacement for source text/evidence.
    ...
    def __post_init__(self) -> None:
        ...
        _optional_text(self.object, "candidate.object")
...
class ExtractionDraft:
    ...
    def __post_init__(self) -> None:
        ...
        _optional_text(self.object, "draft.object")
