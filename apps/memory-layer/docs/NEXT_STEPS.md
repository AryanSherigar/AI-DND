...
> [!WARNING]
> Historical roadmap. It describes the repository before retrieval, API, benchmark, and later ingestion improvements were implemented. Do not use its checkboxes as current project status. See [`BEGINNER_BUILD_FLOW.md`](BEGINNER_BUILD_FLOW.md) for the present code-traced flow and `fixes_and_evaluation_findings.md` for subsequent implementation/evaluation work.

> **Original design reference**: [`FINAL_ARCHITECTURE.md`](../FINAL_ARCHITECTURE.md)  
> **Status**: Historical execution plan for branch `final_merge`  
> **Date**: 2026-08-19  
