...
export const SetupStageCard: React.FC<SetupStageCardProps> = ({
  ...
  const setupFields: SetupInputField[] = scenario.setupInputs || [];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setupFields.forEach((field) => {
      if (field.required) {
        ...
        if (
          ...
          newErrors[field.id] = `Selection required for ${field.label}`;
        }
      }
    });
    ...
    // Format choices into markdown payload for initial turn
