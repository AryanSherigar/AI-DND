 ...
 * rather than here, because retryLastTurn — a plain store action, not a
 * React component — needs to re-trigger a submission too. This hook is the
 * component-facing entrypoint components should call.
 */
