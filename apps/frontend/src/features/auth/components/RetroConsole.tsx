...
export const RetroConsole: React.FC<RetroConsoleProps> = ({ onStart, isError, errorMessage }) => {
    ...
    <div className="relative w-full min-h-screen overflow-hidden bg-[linear-gradient(to_bottom,#100d28_0%,#351b3d_60%,#c25833_100%)] flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div
          ...
          style={{ boxShadow: snow1, animation: 'falling-snow 40s linear infinite' }}
        />
        <div
          className="w-[3px] h-[3px] bg-transparent opacity-80"
          style={{ boxShadow: snow2, animation: 'falling-snow 30s linear infinite' }}
        />
        <div
          className="w-[4px] h-[4px] bg-transparent opacity-100"
          style={{ boxShadow: snow3, animation: 'falling-snow 20s linear infinite' }}
        />
      </div>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: 'inset -8px -8px 0px rgba(0,0,0,0.15), inset 8px 8px 0px rgba(255,255,255,0.6)'
        }}
      >
        ...
        <div
          ...
          style={{
            ...
            boxShadow: 'inset -4px -4px 0px rgba(0,0,0,0.4), inset 4px 4px 0px rgba(255,255,255,0.1)'
          }}
        >
          <div className="w-full flex justify-between px-2 mb-2 items-center">
            <div className="w-3 h-3 bg-red-500" style={{ boxShadow: 'inset -1px -1px 0px #880000, inset 1px 1px 0px #ff8888' }} />
            <div className="text-[#a0a5b5] text-[10px] tracking-widest font-bold font-retro">BATTERY</div>
          </div>
          ...
          >
            ...
            {/* Screen Content */}
            <div className="relative z-10 w-full p-4 flex flex-col items-center text-[#0f380f] font-retro text-center">
              {isError ? (
                <div className="flex flex-col items-center space-y-4">
                  <h2 className="text-lg">GAME OVER</h2>
                  <p className="text-[10px] leading-tight break-words px-2">{errorMessage}</p>
                </div>
              ) : (
                <div className="flex flex-col items-center space-y-6">
                  <h1 className="text-2xl leading-tight">AI-DND</h1>
                  <button
                    onClick={handleStart}
                    aria-label="Press Start to Login"
                    className="text-xs cursor-pointer focus:outline-none hover:text-[#306230] transition-colors"
                  >
                    PRESS START
                  </button>
                </div>
          ...
          <div className="mt-4 text-[#a0a5b5] text-[10px] font-retro tracking-widest">AI-DND</div>
        </div>
        ...
        <div className="w-full mt-12 flex justify-between px-2 relative">
          ...
          <div className="relative w-24 h-24">
            {/* Cross shape */}
            <div className="absolute top-1/3 left-0 w-full h-1/3 bg-[#2b2b2b]" style={{ boxShadow: 'inset -4px -4px 0px rgba(0,0,0,0.5), inset 4px 4px 0px rgba(255,255,255,0.1)' }} />
            <div className="absolute top-0 left-1/3 w-1/3 h-full bg-[#2b2b2b]" style={{ boxShadow: 'inset -4px -4px 0px rgba(0,0,0,0.5), inset 4px 4px 0px rgba(255,255,255,0.1)' }} />
            {/* Center dot */}
          ...
          <div className="flex space-x-6 items-end mb-4">
            <div className="flex flex-col items-center">
              <button
                ...
                onClick={() => { setActiveButton('B'); setTimeout(() => setActiveButton(null), 150); }}
                aria-label="B Button"
              />
              <span className="text-[#a49a8c] font-retro mt-3 text-[10px]">B</span>
            </div>
            ...
            <div className="flex flex-col items-center -mt-8">
              <button
                ...
                aria-label="A Button"
              />
              <span className="text-[#a49a8c] font-retro mt-3 text-[10px]">A</span>
            </div>
          </div>
        </div>

        {/* Select / Start Buttons (Pill shaped but pixelated via clip-path) */}
          ...
          <div className="flex flex-col items-center">
            <div
              ...
              style={{
                ...
                boxShadow: 'inset -2px -4px 0px rgba(0,0,0,0.5), inset 2px 2px 0px rgba(255,255,255,0.2)'
              }}
            />
            <span className="text-[#a49a8c] font-retro text-[8px] mt-3 tracking-widest">SELECT</span>
          </div>
          <div className="flex flex-col items-center">
            <div
            ...
            />
            <span className="text-[#a49a8c] font-retro text-[8px] mt-3 tracking-widest">START</span>
          </div>
        </div>
        ...
        <div className="absolute bottom-6 right-6 flex space-x-2 transform -rotate-12">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="w-2 h-14 bg-[#b8a99a]" style={{ boxShadow: 'inset 2px 2px 0px rgba(0,0,0,0.2)' }} />
          ))}
        </div>
