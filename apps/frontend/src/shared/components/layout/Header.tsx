    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex items-center justify-between">
      ...
      <div className="relative z-10 flex items-center justify-between w-full max-w-7xl mx-auto">
        ...
        <Link to="/" className="flex items-center gap-2">
          <span className="font-fell-sc text-white text-2xl font-bold tracking-wider drop-shadow-md">
            AI-DND
          </span>
        </Link>

        {/* Center: Nav */}
        <nav className="hidden md:flex items-center gap-8 font-mono text-sm tracking-wider text-white/90">
          <Link
            to="/discover"
            className="hover:text-white transition-colors drop-shadow-sm hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]"
          >
            Discover
          </Link>
          <Link
        ...
        <div className="flex items-center gap-4 font-mono">
          {user ? (
            ...
            <Link
              to="/login"
              className="px-5 py-2 rounded-md bg-white/10 hover:bg-white/20 border border-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.3)] transition-all text-white font-medium text-sm"
            >
              Sign In
            </Link>
          )}
