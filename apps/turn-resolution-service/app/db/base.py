...
TRS connects to the same Postgres schema core-api's Alembic migrations own
(ADR-3: single Postgres store). These ORM models mirror the subset of that
shared schema TRS actually reads or writes — they don't run migrations of
their own.
"""
